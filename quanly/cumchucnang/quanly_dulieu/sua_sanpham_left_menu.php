...
class class__khung_sua_sanpham_menu_doc
{
	...
	function khung_sua_sanpham_menu_doc()
	{
		...
		echo "<tr>";
			...
			echo "<td width=\"80%\" align=\"left\"><input name=\"tieude\" size=\"25\" value=\"$row_dulieu_sua[tieu_de]\"></td>";
		echo "</tr>";
		//xuat_tr("Tiêu đề :<br>(English)","<input name=\"tieude_en\" size=\"70\" value=\"$row_dulieu_sua[tieu_de__en]\">");
		echo "<tr>";
			echo "<td width=\"20%\" align=\"left\" valign=\"top\"><b>Hình ảnh : </b></td>";
			echo "<td width=\"80%\" align=\"left\">";
				echo "<input type=\"file\" name=\"uploadedfile\"><br>";
				echo "<img src=\"../hinhanh_flash/sanpham/$ten_hinh\" width=\"210px\" height=\"280px\">";
		...
		echo "<tr>";
			...
			echo "<td width=\"80%\" align=\"left\"><input name=\"giaban\" size=\"25\" value=\"$gia\">";

			echo "</td>";
		echo "</tr>";
		echo "<tr>";
					echo "<td width=\"20%\" align=\"left\"><b>Khối lượng : </b></td>";
					echo "<td width=\"80%\" align=\"left\"><input name=\"khoi_luong\" size=\"25\" value=\"$khoi_luong\">";

					echo "</td>";
				echo "</tr>";
				echo "<tr>";
					echo "<td width=\"20%\" align=\"left\" valign='top'><b>Size : </b></td>";
					echo "<td width=\"80%\" align=\"left\"><input name=\"size\" size=\"25\" value=\"$size\">";
				...
				echo "<tr>";
					...
					echo "<td width=\"80%\" align=\"left\"><input name=\"keywords\" size=\"25\" value=\"$keywords\">";

					echo "</td>";
				echo "</tr>";
				echo "<tr>";
					echo "<td width=\"20%\" align=\"left\"><b>Description : </b></td>";
					echo "<td width=\"80%\" align=\"left\"><input name=\"description\" size=\"25\" value=\"$description\">";

					echo "</td>";
		//xuat_tr("Trạng thái :<br>(English)","<input name=\"trang_thai__en\" size=\"70\" value=\"$row_dulieu_sua[trang_thai__en]\">");

		//xuat_tr("Khuyến mãi :<br>(English)","<input name=\"khuyen_mai__en\" size=\"70\" value=\"$row_dulieu_sua[khuyen_mai__en]\">");
		echo "<tr>";
