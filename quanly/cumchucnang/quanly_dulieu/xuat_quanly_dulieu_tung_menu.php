...
{
	$dem="select count(*) from dulieu where thuoc_menu in ('$_GET[id_menu]')";
...
$dulieu_sp="select * from $tb__dulieu where $tb__dulieu__f__thuoc_menu in ('$_GET[id_menu]') order by $tb__dulieu__f__id desc limit $vtbd,$sd";
$query_dulieu_sp=mysql_query($dulieu_sp);
while($row_dulieu_sp=mysql_fetch_array($query_dulieu_sp))
{
	$tieu_de=$row_dulieu_sp[$tb__dulieu__f__tieu_de];
	$id_sp=$row_dulieu_sp[$tb__dulieu__f__id];
	$link_sua="?thamso=sua_sanpham_left_menu&id_sp=$id_sp";
	$link_xoa="?thamso=quanly_dulieu_left_menu&id_menu=$_GET[id_menu]&id_sp=$id_sp";
