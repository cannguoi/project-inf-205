...
<?php
	$tv="select * from slide where vi_tri='2' order by id limit 0,10";
	$tv_1=mysql_query($tv);
	...
	<table style="margin:6px 0px" id="er_5" width="970px" id="jk899">
		...
		<tr>
			<td>
				...
				?>
				<input type="hidden" name="sua_slide_2" value="sua_slide_2">
							...
							<span style="font-size:14px;margin-left:124px">Kích cỡ hình nên chọn là 410x220</span>
							<div style="width:5px;height:6px;overflow:hidden"></div>
			</td>
		</tr>
	</table>
