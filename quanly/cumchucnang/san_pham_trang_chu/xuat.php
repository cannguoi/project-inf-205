...
<?php
	$tv="select * from san_pham_trang_chu order by id limit 0,10";
	$tv_1=mysql_query($tv);
			...
			<td>
				...
				?>
						<table id="er_<?php echo $z; ?>" style="margin:6px">
							<tr>
								<td>Tiêu đề <?php echo $i; ?> :</td>
								<td ><input name="tieu_de_<?php echo $r; ?>" value="<?php echo $tv_2['tieu_de']; ?>" class="oo89" ></td>

							</tr>
							<tr>
								<td>Giá <?php echo $i; ?> :</td>
								<td ><input name="gia_<?php echo $r; ?>" value="<?php echo $tv_2['gia']; ?>" class="oo89" ></td>
				...
				?>
				<input type="hidden" name="sua_san_pham_trang_chu" value="sua_san_pham_trang_chu">
