	...
	<form action="" method="post" style="margin:0">
		<table id="er" width="968px" style="text-align:left;margin-top:6px">
			<tr>
				<td>
					Sữa thành viên
					<a href="?thamso=quanly_thanhvien&tu_khoa=<?php echo $_GET['tu_khoa']; ?>&trang=<?php echo $_GET['trang']; ?>" style="display:inline-block;margin-left:815px;color:#0b55c4;outline:0;text-decoration: none;" hidefocus="true">Đóng</a>
				</td>
			</tr>
			<tr>
				<td>
