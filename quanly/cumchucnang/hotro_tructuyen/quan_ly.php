...
<table id="er" style="text-align:left;margin:6px 6px 6px 6px;font-size:16px;color:#666666">
	<tr>
		<td width="350px">Tên nick</td>
		<td width="100px">Loại nick</td>
	...
	<?php
		...
		{
				$link_sua="?thamso=sua_nick_httt&id=$tv_2[id]&trang=$_GET[trang]";
				$link_xoa="?thamso=xoa_nick_httt&id=$tv_2[id]&trang=$_GET[trang]";
			?>
				<tr>
					<td ><a href="<?php echo $link_sua; ?>" class="thua__link_1"><?php echo $tv_2['nickname']; ?></a></td>
					<td ><?php echo $tv_2['loai_nick']; ?></td>
