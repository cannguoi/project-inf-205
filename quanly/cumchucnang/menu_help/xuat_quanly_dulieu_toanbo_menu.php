...
echo "<table id=\"er\">";
	echo "<tr >";
		...
		echo "<td width=\"150px\" align=\"left\">";
			echo "Tên menu";
		echo "</td>";
		echo "<td width=\"230px\" align=\"left\">";
			echo "Tên bài viết";
		echo "</td>";
		o_2("Nội dung","370px");
...
//$dulieu_sp=chuoi_union_dulieu($_GET['id_menu'],"help");
$dulieu_sp="select * from help order by id";
...
while($row_dulieu_sp=mysql_fetch_array($query_dulieu_sp))
{
	...
	$link_sua="?thamso=sua_menu_help&id_sp=$row_dulieu_sp[id]&id_menu=$_GET[id_menu]&trang=$_GET[trang]";
	$link_xoa="?thamso=xoa_menu_help&id_menu=$_GET[id_menu]&id_sp=$row_dulieu_sp[id]";
	echo "<tr >";
		//o(img("$link_hinh","","100px","100px"),"style=\"text-align:center;\"");

		echo "<td align=\"left\">";
			echo "<a href=\"$link_sua\" class=\"thua__link_1\">";
				echo "$row_dulieu_sp[ten_menu]";
			echo "</a>";
		echo "</td>";
		echo "<td align=\"left\">";
			echo "<a href=\"$link_sua\" class=\"thua__link_1\">";
